<?php $page = 'home'; include('header'); include('simplecontactvalidation.php'); ?>

<link rel="stylesheet" type="text/css" href="css/style.css" />


<div class="container" style="padding-top: 95vh;">


  <form id="ajax-contact" method="post" class="form -successhide" action="simplecontactvalidation.php">

    <h3 class="-sectionhead -txtcenter" style="text-transform: none;">i can make ajax work </h3>
