<?php $page = 'Savory Living'; $project = '1'; include('header.php'); ?>

<section>

  <div class="wrapper page-top">
    <h1 id="maincontent" class="page-title -float">Savory Living </h1>

    <div class="page-buttons">
      <a class="button" href="http://www.savoryliving.com" target="_blank" rel="nofollow">Visit this site</a>
    </div>
  </div><!-- /.wrapper -->
  ...
  <div class="wrapper page-text">
    <p class="p -large">design &bull; development &bull; CSS &bull; jQuery &bull; ColdFusion</p>
