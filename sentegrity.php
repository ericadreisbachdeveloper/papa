...
<section>
  ...
  <div class="wrapper page-text">
    <p class="p -large">Wordpress &bull; Bootstrap 3 &bull; slideshow &bull; retina &bull;&nbsp;responsive </p>

    <p class="p -medium">Wordpress theme development using <a href="http://www.getbootstrap.com/" target="_blank">Bootstrap&nbsp;3</a> for a mobile security&nbsp;app. Site includes homepage slideshow, contact&nbsp;form, and click&#8209;to&#8209;display content built with <a href="http://www.advancedcustomfields.com/" target="_blank">Advanced Custom&nbsp;Fields</a>. All icons created with <a href="http://glyphicons.com/" target="_blank">Glyphicons</a> or vector svgs with gif backup for graceful degradation in older&nbsp;browsers. </p>
