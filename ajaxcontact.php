<form id="contactform" name="contact" method="post" style="position: relative;">
  ...
  <h3 class="-contactsectionhead -sectionhead -txt-center -large">Wanna Work Together? </h3>

  <p class="p -txt-center" style="margin-top: 1.5em; margin-bottom: 2em; line-height: 1.6;">Projects start at&nbsp;$595. Need it cheaper? <a class="a" href="cheap">Click&nbsp;here</a>. <br />
