...
<section>
  ...
  <div class="wrapper page-top">
    <h1 id="maincontent" class="page-title -float">Nearby Registry </h1>
  ...
  <div class="wrapper page-text">
    <p class="p -large">CSS &bull; ColdFusion &bull; jQuery </p>

    <p class="p -medium">Worked with a team of UX designers at Merit System Services on a website that promotes local businesses through a unique online registry interface. Significant styling and implementation work in jQuery, ColdFusion, and CSS. Built and added modal windows and <a href="http://www.starplugins.com/cloudzoom" target="_blank">Cloud&nbsp;Zoom</a>. Implemented social media modules for Twitter and Facebook. Maintained version control amongst a team spread across the country using <a href="http://subversion.apache.org/" target="_blank">Subversion</a>. Design&nbsp;by&nbsp;<a href="http://youngathenians.com/" target="_blank">Young&nbsp;Athenians</a>. </p>
