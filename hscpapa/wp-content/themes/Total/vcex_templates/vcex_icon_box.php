...
if ( $hover_white_text ) {
    $wrapper_classes['hover-white-text'] = 'hover-white-text';
    $css_wrap_classes[] = 'hover-white-text';
}
if ( $hover_animation ) {
...
if ( $css && in_array( $style, array( 'one', 'seven' ) ) ) : ?>
    ...
    if ( isset( $wrapper_classes['hover-white-text'] ) ) {
        unset( $wrapper_classes['hover-white-text'] );
    }
