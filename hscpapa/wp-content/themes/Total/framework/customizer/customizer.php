    ...
    class WPEX_Customizer {
        ...
        public function __construct() {
            ...
            $this->panels = array(
                ...
                'header_image'      => __( 'Header Image', 'wpex' ),
            ...
            $this->exclude_panels_from_defaults = array( 'title_tagline', 'header_image', 'widgets', 'nav' );
        ...
        public function adminbar_menu( $wp_admin_bar ) {
            ...
            // Add wpex_customizer node to the admin bar 
        ...
        public function admin_scripts( $hook ) {
            ...
            if ( WPEX_ADMIN_PANEL_HOOK_PREFIX . '-customizer' != $hook ) {
                return;
            }
        ...
        public function customize_register( $wp_customize ) {
			...
			if ( ! isset( $enabled_panels['header_image'] ) ) {
            ...
            $exclude_panels = array( 'title_tagline', 'header_image', 'static_front_page', 'nav', 'widgets', 'typography', 'styling' );
