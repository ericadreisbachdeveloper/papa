 ...
 * @since 2.1.0
 */
function wpex_global_obj( $property = null ) {
...
function wpex_get_term_data() {
	...
	if ( ! empty( $wpex_theme->term_data ) ) {
		return $wpex_theme->term_data;
	}
...
function wpex_slider_data() {
	...
	// Apply filters for child theming
	$attributes = apply_filters( 'wpex_slider_data', $attributes );
