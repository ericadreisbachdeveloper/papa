...
if ( ! function_exists( 'wpex_font_awesome_css_url' ) ) {
	function wpex_font_awesome_css_url() {
		return WPEX_CSS_DIR_URI .'font-awesome.min.css';
	}
}
...
function wpex_standard_fonts() {
	...
	return apply_filters( 'wpex_standard_fonts_array', $fonts );
}
...
function wpex_enqueue_google_font( $font ) {
	...
	// Enqueue style
	wp_enqueue_style( 'googlefont-'. $handle, 'https://fonts.googleapis.com/css?family='. str_replace(' ', '%20', $font ) .':300italic,400italic,600italic,700italic,800italic,700,300,600,800,400&subset=latin,cyrillic-ext,greek-ext,vietnamese,latin-ext', false, false, 'all' );
