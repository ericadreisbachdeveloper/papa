                    ...
                    <table class="form-table">
                        ...
                        <tr valign="top">
                            ...
                            <td>
                                <fieldset>
                                    <label>
                                        <input id="wpex_retina" type="checkbox" name="wpex_image_sizes[retina]" <?php checked( wpex_get_mod( 'retina' ), true ); ?>> <?php _e( 'Enable retina support for your site (via retina.js).', 'wpex' ); ?>
                                    </label>
                                </fieldset>
                            </td>
                        </tr>
