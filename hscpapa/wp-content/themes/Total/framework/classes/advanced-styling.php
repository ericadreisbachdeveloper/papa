        ...
        public function generate( $output ) {
            ...
            if ( ! $wpex_theme->has_overlay_header ) {
                if ( 'one' == $wpex_theme->header_style ) {
                    $header_top_padding     = intval( wpex_get_mod( 'header_top_padding' ) );
                    $header_bottom_padding  = intval( wpex_get_mod( 'header_bottom_padding' ) );
                    $header_height          = intval( wpex_get_mod( 'header_height' ) );
            ...
            if ( ! $header_height ) {
                ...
                // Logo top margin
                $margin = intval( wpex_get_mod( 'logo_top_margin' ) );
                if ( $margin && '0' != $margin ) {
                ...
                // Logo bottom margin
                $margin = intval( wpex_get_mod( 'logo_bottom_margin' ) );
                if ( $margin ) {
