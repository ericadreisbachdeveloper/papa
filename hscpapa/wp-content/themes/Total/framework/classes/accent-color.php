...
if ( ! class_exists( 'WPEX_Accent_Color' ) ) {
    ...
    class WPEX_Accent_Color {
        ...
        public function arrays( $return ) {
            ...
            $texts = apply_filters( 'wpex_accent_texts', $texts );
            ...
            $backgrounds = apply_filters( 'wpex_accent_backgrounds', $backgrounds );
            ...
            $borders = apply_filters( 'wpex_accent_borders', $borders );
