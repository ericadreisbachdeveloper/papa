...
<section>
  <div class="wrapper page-top">
    <h1 id="maincontent" class="page-title -float">Educare </h1>
  ...
  <div class="wrapper page-text">
    <p class="p -large">Wordpress &bull; Bootstrap 3 &bull; HTML5 &bull; slideshow &bull; Advanced&nbsp;Custom&nbsp;Fields &bull; Custom&nbsp;Post&nbsp;Types </p>
