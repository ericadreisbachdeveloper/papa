<section id="sitemap">
  <div class="wrapper">
    ...
    <ul class="nav">
      ...
      <li class="location"><a class="link" href="<?php if(isset($page)){ echo './'; } else {} ?>/pdf/resume.pdf">Resume </a></li>
    ...
    <ul class="nav">
      ...
      <li class="location"><a class="link" href="wilmington">Wilmington Ballet Academy </a></li>
...
<section id="credits" class="-lean">
 <div class="wrapper">
  ...
  <p class="p">This site built with <a href="http://www.get-sass.lang" target="_blank">SASS</a> and&nbsp;<a href="http://www.gruntjs.com" target="_blank">Grunt</a>&nbsp;&mdash; the web&nbsp;development tools and also their homophonic&nbsp;cognates.  </p>

  <?php if(isset($page)) : ?><p class="p">Lightweight mobile/adaptive carousel from <a href="http://owlgraphic.com/owlcarousel/" target="_blank">Owl&nbsp;Carousel</a>. </p>
  <?php else : ?><p class="p"><a href="http://pixelcog.github.io/parallax.js/" target="_blank" rel="nofollow">Parallax.js</a> for a buttery&#8209;smooth parallax&nbsp;effect.</p>
  <?php endif; ?>
