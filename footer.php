...
<!-- home cooked stuff -->
<?php global $homedir; if($bodyclass !== "home") { $homedir = "../"; } else { $homedir = ""; }?>

<script type="text/javascript">var homedir = "<?= $homedir ?>";</script>

<script async="async" src="<?php if($bodyclass !== "home") { echo $homedir; }?>js/DEV/dev-papa.js"></script>
