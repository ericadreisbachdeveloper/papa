<?php $bodyclass = 'work'; $page = 'Educare'; $metadescription = 'Educare | responsive Wordpress/Boostrap theme web development by Erica Dreisbach.'; include('../header.php'); ?>



<section id="maincontent" class="section">
  <div class="container">
    <h1 class="-pagehead -desktopfloatleft">Educare </h1>
    <a class="-ghost -desktopfloatright -samesize -txtcenter -visit" href="http://www.educareschools.org" target="_blank" rel="noopener">Visit this site <i class="fa fa-arrow-circle-right -diagonal" aria-hidden="true"></i></a>
  </div>
</section>
...
<section class="description-section">
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-12">
        <p class="p -txtcenter -bigpadding"><a href="http://www.communicatorawards.com/winners/gallery/?event=52&category=Websites%20-%20Education&search=Search..." target="_blank" rel="noopener" class="-ghost -naturalsize">WINNER - Annual Communicator Award of&nbsp;Excellence</a> <br /><br /></p>
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-md-8 col-content">
        ...
        <p class="p -txtcenter -medium">Wordpress &bull; Bootstrap 3 &bull; HTML5 &bull; slideshow &bull; Advanced&nbsp;Custom&nbsp;Fields &bull; Custom&nbsp;Post&nbsp;Types </p>

        <p class="p">Custom Wordpress theme built with for a national network of schools that work with young at&#8209;risk children. Theme includes several templates for section pages, school profiles, news items, and an interactive US&nbsp;map. Development makes extensive use of <a href="https://codex.wordpress.org/Post_Types" target="_blank" rel="noopener" class="a">Custom&nbsp;Post&nbsp;Types</a> and <a href="http://www.advancedcustomfields.com/" target="_blank" rel="noopener"  class="a">Advanced&nbsp;Custom&nbsp;Fields</a> to seamlessly maintain and integrate school profile, news, events, and page&nbsp;content.  Design&nbsp;by&nbsp;<a href="http://www.teamodea.com" target="_blank" rel="noopener" class="a">Odea</a>. </p>
      </div>
