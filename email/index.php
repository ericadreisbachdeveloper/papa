<?php $bodyclass = 'page'; $page = 'HTML Email'; $metadescription = 'HTML EMail | Erica Dreisbach | Pro Chicago HTML Email Developer'; include('../header.php'); ?>



<section id="maincontent" class="section">
  <div class="container">
    <h1 class="-pagehead">Selected HTML Email Work </h1>
  </div><!-- /.container -->
</section><!-- /#top -->
...
<section class="email-section">
  <h2 class="hidden">Links to HTML email work </h2>
  <div class="container">
    <div class="row">
